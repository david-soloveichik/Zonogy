...
Zonogy divides each display into persistent tiling zones plus a floating zone. At any time, at most one zone is the destination for the next window. A keyboard-driven Launcher and hover-over DockMenus let you quickly find any window. Window arrangements can be snapshotted and restored to switch working contexts.
...
<a href="https://youtu.be/rcInUytB798"><img src="docs/images/video-thumbnail.png" alt="Watch the Zonogy demo video on YouTube" width="1512" /></a>
...
- **Keyboard Zone Navigation** — the geometric arrangement of zones makes navigation of zones and windows unambiguous via keyboard.
...
| `Control-Cmd-\` | Toggle destination with the focused window's tiling zone |
