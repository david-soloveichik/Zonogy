...
- On first show, AltTab selects the second item (index 1), which is the previously active window (index 0 is the currently active window). If invoked with Shift held, it selects the least-recent window.
