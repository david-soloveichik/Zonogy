...
enum PlaceholderPassThroughPolicyTests {
    ...
    static func run() -> Bool {
        ...
        do {
            ...
            assertEqual(holes.rects, [CGRect(x: 300, y: 300, width: 200, height: 200)], label: "behind-overlapping")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "in-front-no-hole")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "own-pid-excluded")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "non-normal-layer-excluded")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "zero-alpha-excluded")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "sliver-overlap-ignored")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "no-overlap-no-hole")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "tiny-window-ignored")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [CGRect(x: 300, y: 100, width: 200, height: 400)], label: "excluded-row-above-deeper-candidate")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [placeholderFrame], label: "full-cover-full-hole")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "placeholder-missing")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [CGRect(x: 300, y: 300, width: 200, height: 200)], label: "mixed-stack")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [CGRect(x: 480, y: 460, width: 20, height: 40)], label: "icon-clipped-at-edge")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "icon-no-overlap")
        }
        ...
        do {
            ...
            assertEqual(holes.rects, [], label: "icon-placeholder-missing")
        }
        ...
        // Window holes carry their window's number (so callers can tell windows apart across
        // refreshes) and are kept separate from icon holes.
        do {
            let behind = row(7, CGRect(x: 300, y: 300, width: 400, height: 300))
            let icon = CGRect(x: 200, y: 200, width: 64, height: 64)
            let holes = PlaceholderPassThroughPolicy.holes(
                placeholderCgWindowId: 1,
                rowsFrontToBack: [placeholder, behind],
            ...
            let expectedWindows = [
                PlaceholderPassThroughPolicy.WindowHole(windowNumber: 7, rect: CGRect(x: 300, y: 300, width: 200, height: 200))
            ]
            guard holes.windows == expectedWindows, holes.icons.count == 2, !holes.isEmpty else {
                print("PlaceholderPassThroughPolicyTests: windows-and-icons-split failed: \(holes)")
                allPassed = false
                return false
            }
        }

        // Frame-based variant: predicting a placeholder's holes before it exists (or is on top)
        // treats every row as behind it, so a window currently in front still punches.
        do {
            let inFront = row(2, CGRect(x: 300, y: 300, width: 400, height: 300))
            let predicted = PlaceholderPassThroughPolicy.holes(
                placeholderFrame: placeholderFrame,
                rowsBehind: [inFront],
                zonogyPid: zonogyPid
            )
            assertEqual(predicted.rects, [CGRect(x: 300, y: 300, width: 200, height: 200)], label: "predicted-ignores-z-order")

            // And it matches the window-number variant once the placeholder is on top.
            let actual = PlaceholderPassThroughPolicy.holes(
                placeholderCgWindowId: 1,
                rowsFrontToBack: [placeholder, inFront],
                zonogyPid: zonogyPid
            )
            guard actual == predicted else {
                print("PlaceholderPassThroughPolicyTests: predicted-matches-actual failed")
                allPassed = false
                return false
            }
        }
