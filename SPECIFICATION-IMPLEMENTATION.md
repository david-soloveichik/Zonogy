...
- The analogous mouse taps stay on the main run loop. But we try to make them enabled only while a click or drag could concern Zonogy; see the Click Interception and Dock Icon Drag Interception notes in `SPECIFICATION-DOCKMENUS.md`.
